...
CLASS lhc_Travel IMPLEMENTATION.
  ...
  METHOD update.
    ...
    LOOP AT entities ASSIGNING FIELD-SYMBOL(<entity>).
      ...
      legacy_entity_x-_intx = CORRESPONDING zssergi_travel_x_01( <entity> MAPPING FROM ENTITY ).
  ...
  METHOD cba_Booking. "Create-By-Association
  ...
  METHOD rba_Booking. "Read-By-Association -> READS form the buffer
...
CLASS lsc_ZERGI_I_TRAVEL_U_01 DEFINITION INHERITING FROM cl_abap_behavior_saver.
  PROTECTED SECTION.
...
CLASS lsc_ZERGI_I_TRAVEL_U_01 IMPLEMENTATION.
